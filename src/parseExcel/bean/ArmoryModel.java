...
public class ArmoryModel {
	...
	public String buildAddSql() {
		...
		sqlBuffer.append("insert into `pureland`.`armory_model`(`id`,`race_type`,`build_type`,`base_id`) values(").append(this.getId()).append(",'")
				.append(this.getRaceType()).append("',").append(this.getBuildType()).append(",").append(this.getBaseId()).append(")");
